...
function registro(){
    var jugador1 = document.forms["registro-jugadores"]["jugador1"].value;
    var jugador2 = document.forms["registro-jugadores"]["jugador2"].value;
    var validacion = true;

    if (jugador1 == "") {
        console.log("El campo jugador 1 esta vacio");
        validacion = false;
    }
    if (jugador2 == "") {
        console.log("El campo jugador 1 esta vacio");
...
const userImg = document.getElementById("usurio-img");
